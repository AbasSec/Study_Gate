 ...
 * StudyGate International Educational Agency
 */

// Theme constants
const THEME_KEY = 'StudyGate International-theme';
...
function setTheme(theme) {
    // Apply both data-theme (for custom CSS) and dark class (for Tailwind)
...
function initTheme() {
    ...
    // Wire up the toggle button (for pages that don't use onclick="toggleTheme()")
    const toggleBtn = document.getElementById('themeToggle');
